...
const eCommerceWebsites: SolutionPageData = {
  ...
  metaDescription:
    'Custom e-commerce development on Next.js and Azure/AWS. Headless architecture, AI personalization, platform migrations from Shopify/Magento/WooCommerce, and tokenized PCI checkout.',
  keywords: [
  ...
  hero: {
    ...
    subhead:
      'Custom Next.js storefronts on Azure/AWS with AI-powered personalization, tokenized checkout, and full platform-migration expertise. Architected for Core Web Vitals leadership and to scale without per-transaction platform fees.',
  ...
  metricsStrip: [
    ...
    },
    {
      ...
      description:
        'Real-time product recommendations, dynamic bundling, and personalized search results architected to lift average order value.',
    },
    {
      value: 'Frictionless',
      label: 'Checkout Flow',
      description:
        'Tokenized payments, express options, and progress-optimized checkout designed to minimize cart abandonment.',
    },
  ],
  ...
  features: [
    {
      icon: 'ShoppingCart',
      title: 'Custom Storefront & Product Catalog',
      description:
        'Pixel-perfect storefronts with advanced filtering, faceted search, variant management, and rich product pages optimized for both conversion and organic search — built to your brand, not a template.',
    },
    {
      icon: 'Sparkles',
      title: 'AI Product Recommendations & Personalization',
      description:
        'Real-time recommendation engine using collaborative filtering and browsing behavior to surface relevant products at every stage of the customer journey, architected to lift conversion rate and average order value.',
    },
    {
      icon: 'Package',
      title: 'Inventory & Order Management',
      description:
        'Real-time inventory tracking across warehouses, automated reorder triggers, order lifecycle management, and fulfillment partner integrations so your operations team has full visibility without switching between tools.',
    },
    // Integration-woven feature (Decision C mitigation 1) — checkout + payments.
    {
      ...
      description:
        'Tokenized checkout with Stripe, Braintree, or Adyen keeps raw card data out of your environment (PCI DSS SAQ A), while supporting Apple Pay, Google Pay, Buy-Now-Pay-Later, multi-currency, and localized tax calculation via Avalara or TaxJar.',
    },
  ...
  benefits: [
    ...
    {
      icon: 'Sparkles',
      title: 'Personalization Built In, Not Bolted On',
      description:
        'Every visitor sees a storefront adapted to their behavior and preferences — product recommendations, dynamic banners, personalized search results — architected into the storefront from day one rather than layered on via third-party tags.',
    },
    {
      icon: 'Layers',
  ...
  processSteps: [
    {
      ...
      description:
        'We analyze your target customer segments, competitor storefronts, and current conversion bottlenecks to define a product strategy grounded in data. For migrations, we audit your existing platform to identify what to preserve, improve, and replace.',
      duration: '1–2 weeks',
      deliverable:
        'Competitive analysis, user journey maps, conversion audit (for migrations), and prioritized feature roadmap',
    },
    {
    ...
    },
    {
      ...
      description:
        'Frontend development in Next.js with App Router, TypeScript, and Tailwind CSS. Backend commerce logic via a headless CMS and custom API layer, with AI recommendation and personalization services built in from the start rather than layered on later.',
      duration: '6–12 weeks',
      deliverable:
    ...
    },
    {
      ...
      description:
        'Production launch with DNS migration support, 301 redirect mapping for SEO preservation, Google Search Console setup, and a structured A/B testing program to continuously improve conversion rate post-launch. We provide a defined hypercare period of monitoring and optimization support.',
      duration: '1–2 weeks',
      deliverable:
  ...
  capabilities: [
    ...
    'Multi-warehouse and 3PL fulfillment integration',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        'We integrate with Stripe, Braintree, Adyen, or your existing payment processor of choice. By using hosted payment fields and tokenization, the custom storefront itself never handles raw card data, which means it falls under PCI DSS SAQ A (the lightest compliance tier) rather than requiring a full PCI audit. We document the payment architecture for your compliance records and test all payment flows end-to-end before launch.',
    },
    {
      question: 'Will a custom build outperform Shopify for SEO?',
      answer:
        'A well-built custom Next.js storefront is architected to outperform Shopify for Core Web Vitals (particularly LCP and CLS) because there is no platform overhead — every request is optimized for your specific product catalog. You also get full control over URL structures, schema markup, meta data, and canonical tags without workarounds. The SEO advantage compounds over time as Google rewards sites with consistently strong performance signals.',
    },
    {
      question:
        'How do you handle high-traffic events like product launches or seasonal peaks?',
      answer:
        'The infrastructure is designed for elastic scaling from day one. We deploy on Azure or AWS with auto-scaling groups, a global CDN for static and semi-static content, database read replicas for query-heavy catalog pages, and Redis caching for sessions and product data. Before major traffic events, we conduct load testing to validate the system handles projected peak load without degradation.',
    },
    {
  ...
  //   metricsStrip[2] "20–30% AOV lift" — REPLACED with "AI-powered / Personalization Engine".
