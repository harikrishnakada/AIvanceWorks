...
const retail: IndustryPageData = {
  ...
  _unverified: [
    ...
    'complianceDetail.frameworks — "SOC 2" and "ISO 27001" listed; confirm whether {SITE_CONFIG.name} holds these attestations or is in progress. PCI DSS, GDPR/CCPA, PSD2/SCA, and ADA/WCAG framing describes payment-handling and data-protection design practices, not held certifications or a legal compliance guarantee.',
