...
const banking: IndustryPageData = {
  ...
  _unverified: [
    ...
    `complianceDetail.frameworks — SOC 2 and ISO 27001 are listed; confirm whether {SITE_CONFIG.name} holds these attestations or is in progress. PCI DSS, GLBA, GDPR/CCPA, and BSA/AML framing describes security and data-protection ENGINEERING practices and framework compatibility, NOT held certifications, a regulatory-compliance guarantee, or authorship of the institution\'s compliance program (explicitly scoped to the client\'s compliance officers/examiners).`,
